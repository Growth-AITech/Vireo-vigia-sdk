# Vireo Vigía SDK — Arbitrum Buildathon Submission

**Category:** AI Agentic  
**Repo:** https://github.com/Growth-AITech/Vireo-vigia-sdk  
**Builder:** Mael De La Hoz · Vireo · Bucaramanga, Colombia
...
**Vireo Vigía SDK** — an open-source Python SDK that deploys a 24/7 AI support
...
Arbitrum pay $5K-15K/month for human support teams. Vireo Vigía replaces 70-80% of
that workload at 10% of the cost.

**LATAM angle.** Vireo is based in Bucaramanga, Colombia — first
...
- Discord bot live: `Vireo Agent`
- GitHub: https://github.com/Growth-AITech/Vireo-vigia-sdk
...
uv sync --all-extras
cp .env.example .env  # set VIREO_ANTHROPIC_API_KEY
...
*Vireo · Bucaramanga, Colombia · github.com/Growth-AITech*
