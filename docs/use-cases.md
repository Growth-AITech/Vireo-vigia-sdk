...
# 2. Set env vars
VIREO_DISCORD_BOT_TOKEN=your-token
VIREO_HL_WALLET_ADDRESS=0x...
...
```bash
VIREO_TELEGRAM_BOT_TOKEN=your-token
VIREO_ARBITRUM_RPC_URL=https://arb-mainnet.g.alchemy.com/v2/YOUR_KEY
...
```bash
# Terminal 1 — Discord
VIREO_DISCORD_BOT_TOKEN=... uv run python examples/discord_demo/bot.py

# Terminal 2 — Telegram
VIREO_TELEGRAM_BOT_TOKEN=... uv run python examples/telegram_demo/bot.py
```
...
| Feature | Vireo Vigía SDK | Generic chatbot |
|---|---|---|
