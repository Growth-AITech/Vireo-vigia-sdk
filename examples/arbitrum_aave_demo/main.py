#!/usr/bin/env python3
"""
Vireo Vigía — Arbitrum / Aave V3 demo.

Shows the Vireo Vigía agent reading live Aave V3 positions on Arbitrum
...
Prerequisites:
  Set in .env:
    ...
    VIREO_ARBITRUM_RPC_URL=https://arb1.arbitrum.io/rpc   (or Alchemy URL)
...
_BANNER = """[bold cyan]Vireo Vigía — Arbitrum / Aave V3[/bold cyan]
