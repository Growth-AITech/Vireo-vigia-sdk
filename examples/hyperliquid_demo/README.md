...
# From repo root
cp .env.example .env
# Fill in VIREO_ANTHROPIC_API_KEY and VIREO_OPENAI_API_KEY at minimum
...
Ingesting 7 documents into collection vireo_docs...
...
| Env var | Effect |
|---|---|
| `VIREO_HL_NETWORK=testnet` | Use testnet instead of mainnet |
| `VIREO_LLM_MODEL=claude-opus-4-5` | Use a different Claude model |
| `VIREO_QDRANT_COLLECTION=my_docs` | Use a custom collection |
